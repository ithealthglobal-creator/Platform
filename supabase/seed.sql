...
-- ---------------------------------------------------------------------------
-- 3. MENU ROLE GRANTS (menu_items themselves are inserted by migrations)
-- ---------------------------------------------------------------------------
-- Safety net: ensure admin role can access every non-customer item, in case
-- a future migration forgets to grant admin access. Customer items live under
-- ids prefixed with 'c0000000' and are explicitly excluded.
...
-- =============================================================================
-- MULTI-TENANT PLATFORM SEEDS (Phase 1-5)
-- =============================================================================
